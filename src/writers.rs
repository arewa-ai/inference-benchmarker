...
pub struct BenchmarkResultsWriter {
    ...
    input_token_throughput_secs: f64,
    token_throughput_median_secs: f64,
    input_token_throughput_median_secs: f64,
    duration_ms: u128,
...
impl BenchmarkResultsWriter {
    pub fn new(results: BenchmarkResults) -> anyhow::Result<BenchmarkResultsWriter> {
        Ok(BenchmarkResultsWriter {
            ...
            input_token_throughput_secs: results.input_token_throughput_secs()?,
            token_throughput_median_secs: results.token_throughput_median_secs()?,
            input_token_throughput_median_secs: results.input_token_throughput_median_secs()?,
